...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "SqueezeNet-Imagenette", targets: ["SqueezeNet-Imagenette"]),
    ...
    targets: [
        ...
        .target(
            name: "SqueezeNet-Imagenette", dependencies: ["ImageClassificationModels", "Datasets"],
            path: "Examples/SqueezeNet-Imagenette"),
