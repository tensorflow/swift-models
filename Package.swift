...
let package = Package(
  ...
  targets: [
    .target(
      ...
      path: "Checkpoints"),
    .target(
      name: "Datasets", dependencies: ["ModelSupport", "TransformerSupport"], path: "Datasets"),
    .target(name: "STBImage", path: "Support/STBImage"),
    .target(
      name: "TransformerSupport", dependencies: ["SwiftProtobuf"], path: "Support/Text/Transformer"),
    .target(
      name: "ModelSupport", dependencies: ["STBImage"], path: "Support",
      exclude: ["STBImage", "Text/Transformer"]),
