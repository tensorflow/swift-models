...
extension Data {
    ...
    public func readVarint32(at index: inout Int) -> Int {
    ...
    public func readByte(at index: inout Int) -> UInt8 {
        let byte = self[index]
        index += 1
        return byte
    }

    public func readDataBlock(at index: inout Int, size: Int) -> Data {
        let dataBlock = self[index..<(index + size)]
        index += size
        return dataBlock
    }

    public func decompressSnappyStream(at index: inout Int) throws -> Data? {
        ...
        while uncompressedData.count < uncompressedLength {
            ...
            case 0:  // Literal string of bytes.
                ...
                case 62:  // Three-byte literal length following the tag byte.
                    ...
                    literalLength =
                        Int(firstByte) + Int(secondByte) * 256 + Int(thirdByte) * 256
                        * 256 + 1
            ...
            case 3:  // Copy with 4-byte offset.
                ...
                let fourthByte = readByte(at: &index)
                var sourceIndex =
                    uncompressedData.count
                    - (Int(firstByte) + Int(secondByte) * 256
    ...
    public func decompressFromSnappy() throws -> Data {
