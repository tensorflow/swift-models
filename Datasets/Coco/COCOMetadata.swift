...
public enum COCOSegmentation {
    ...
    case uncompressedRLE(counts: [Int], size: [Int])
    case compressedRLE(counts: String, size: [Int])
}
...
public struct COCOAnnotation: Decodable {
    ...
    public init(
        ...
        iscrowd: Int, bbox: [Float], category_id: Int, ignore: Int, num_keypoints: Int,
        keypoints: [Int]
    ) {
...
public struct COCOCategory: Decodable {
    ...
    var skeleton: [[Int]]?
    public init(
        supercategory: String, id: Int, name: String, keypoints: [String], skeleton: [[Int]]
    ) {
