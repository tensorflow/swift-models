...
extension IteratorProtocol {
    ...
    public func grouped(
        ...
        GroupedIterator(
            self, keyFn: keyFn, sizeFn: sizeFn, reduceFn: reduceFn, dropRemainder: dropRemainder)
    }
...
extension PrefetchIterator {
    internal class BlockingQueue<Element> {
        private let prefetchingDispatchQueue: DispatchQueue = DispatchQueue(
            label: "PrefetchIterator")
