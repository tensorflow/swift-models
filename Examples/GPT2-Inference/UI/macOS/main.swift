...
func onBackground(_ body: @escaping () -> Void) {
...
class SwiftApplicationDelegate: NSObject, NSApplicationDelegate {
    var window: NSWindow =
        NSWindow(
            contentRect: NSRect(x: 0, y: 0, width: 648, height: 432),
    ...
    lazy var button: NSButton =
        NSButton(
            frame: NSRect(x: 544, y: 386, width: 72, height: 32),
            title: "Generate")
    ...
    lazy var label: NSLabel =
        NSLabel(
            frame: NSRect(x: 24, y: 60, width: 512, height: 20),
            title: "Loading GPT-2 ...")
