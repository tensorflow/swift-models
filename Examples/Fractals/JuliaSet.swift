...
func juliaSet(iterations: Int, constant: ComplexConstant, tolerance: Float, region: ComplexRegion, imageSize: ImageSize, device: Device) -> Tensor<Float> {
    ...
    let C = ComplexTensor(real: Tensor<Float>(repeating: constant.real, shape: xs.shape, on: device),
