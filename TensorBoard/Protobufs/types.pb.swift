...
/// LINT.IfChange
enum TensorboardX_DataType: SwiftProtobuf.Enum {
...
extension TensorboardX_DataType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [TensorboardX_DataType] = [
    .dtInvalid,
    .dtFloat,
    .dtDouble,
    .dtInt32,
...
extension TensorboardX_DataType: SwiftProtobuf._ProtoNameProviding {
