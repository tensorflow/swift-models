...
extension ImportableLayer {
    ...
    public func getRecursiveNamedKeyPaths<T>(
    ...
    public mutating func unsafeImport(parameters: [String: Tensor<Float>], map: ImportMap) {
...
extension ImportableLayer {
    ...
    public mutating func unsafeImport(from reader: CheckpointReader, map: ImportMap) {
